...
class F8801_2018(Form):
    """Form 8801, Credit for Prior Year Minimum Tax

    This form is for 2018, but since it depends on values
    from 2017, it is generated along with 2017's
    forms. Line 21 from this form must be manually entered into
    2018's input dictionary.
    """
    def __init__(f, inputs, f1040, f6251, f8801, sched_d):
        super(F8801_2018, f).__init__(inputs)
        ...
        assert(inputs['status'] != FilingStatus.SEPARATE or f['4'] <= 249450)
        ...
        f['17'] = f.get('15')
        f['18'] = f['16'] - f['17']
        f.comment['19'] = '2017 credit carryforward'
        f['19'] = f8801.get('26')
        f.comment['21'] = 'Accum. credit (enter in 2018 inputs as \'prior_amt_credit\')'
