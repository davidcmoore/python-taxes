...
class F6251(Form):
    ...
    EXEMPTIONS = [81300, 126500, 63250, 81300, 126500]
    EXEMPT_LIMITS = [578150, 1156300, 578150, 578150, 1156300]
    RATE_CHANGE = [220700, 220700, 110350, 220700, 220700]
    def __init__(f, inputs, f1040, sched_a, sched_d, sched_d_re):
        ...
        if f['6'] <= 0:
            ...
            f['6'] = 0
            f['10'] = max(0, f1040['16'] + f1040['s2_2'] - f1040['s3_1'])
            return
