...
class CA540sp(Form):
    EXEMPTION_LIMITS = [326891, 435855, 217924, 326891, 435855]
    EXEMPTIONS = [87171, 116229, 58111, 87171, 116229]
    ...
    def __init__(f, inputs, ca540, ca540sca, f1040, f1040sa):
        ...
        f['19'] = f.rowsum(['1[4-8]'])
        f['21'] = f['19'] - f['20']
        assert(inputs['status'] != FilingStatus.SEPARATE or f['21'] <= 450368)
