...
class CA540(Form):
    EXEMPTION = 106
    DEPENDENT_EXEMPTION = 326
    BRACKET_RATES = [.01, .02, .04, .06, .08, .093, .103, .113, .123]
    BRACKET_LIMITS = [
        [7582, 17976, 28371, 39384, 49774, 254250, 305100, 508500],   # SINGLE
        [15164, 35952, 56742, 78768, 99548, 508500, 610200, 1017000], # JOINT
        [7582, 17976, 28371, 39384, 49774, 254250, 305100, 508500],   # SEPARATE
        [15174, 35952, 46346, 57359, 67751, 345780, 414936, 691560],  # HEAD
        [15164, 35952, 56742, 78768, 99548, 508500, 610200, 1017000], # JOINT
    ]
    SDI_MAX = 1008.80
    ...
    def __init__(f, inputs, f1040):
        ...
        f['47'] = f.rowsum(['40', '42', '43', '44', '45', '46'])
