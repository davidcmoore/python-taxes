...
class F1040(Form):
    STD_DED = [6100, 12200, 6100, 8950, 12200]
    EXEMPTION = 3900
    BRACKET_RATES = [0.10, 0.15, 0.25, 0.28, 0.33, 0.35, 0.396]
    BRACKET_LIMITS = [
        [8925, 36250, 87850, 183250, 398350, 400000],   # SINGLE
        [17850, 72500, 146400, 223050, 398350, 450000], # JOINT
        [8925, 36250, 73200, 111525, 199175, 225000],   # SEPARATE
        [12750, 48600, 125450, 203150, 398350, 425000], # HEAD
        [17850, 72500, 146400, 223050, 398350, 450000], # WIDOW
    ]
    SS_MAX = 7049.40
    ...
    def deduction_for_exemptions(f, status):
        THRESH = [250000, 300000, 150000, 275000, 300000]
        w = {}
