...
class CA540sp(Form):
    EXEMPTION_LIMITS = [292763, 390351, 195172, 292763, 390351]
    EXEMPTIONS = [73070, 104094, 52044, 78070, 104094]
    ...
    def __init__(f, inputs, ca540, ca540sca, f1040, f1040sa):
        ...
        f['21'] = f['19'] - f['20']
        assert(inputs['status'] != FilingStatus.SEPARATE or f['21'] <= 403348)
