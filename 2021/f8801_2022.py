...
class F8801_2022(Form):
    """Form 8801, Credit for Prior Year Minimum Tax

    This form is for 2022, but since it depends on values
    from 2021, it is generated along with 2021's
    forms. Line 21 from this form must be manually entered into
    2022's inputs dictionary.
    """
    def __init__(f, inputs, f1040, f6251, f8801, sched_d):
        super(F8801_2022, f).__init__(inputs)
        ...
        f['17'] = f.get('15')
        f['18'] = f['16'] - f['17']
        f.comment['19'] = '2021 credit carryforward'
        f['19'] = f8801.get('26')
        f.comment['21'] = 'Accum. credit (enter in 2022 inputs as \'prior_amt_credit\')'
        f['21'] = max(0, f['18'] + f['19'] + f['20'])
        if f['21']:
            f.must_file = True

    def title(self):
        return 'Form 8801 (for 2022 filing)'
