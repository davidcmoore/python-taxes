...
class CA540(Form):
    EXEMPTION = 129
    DEPENDENT_EXEMPTION = 400
    BRACKET_RATES = [.01, .02, .04, .06, .08, .093, .103, .113, .123]
    BRACKET_LIMITS = [
        [9325, 22107, 34892, 48435, 61214, 312686, 375221, 625369],   # SINGLE
        [18650, 44214, 69784, 96870, 122428, 625372, 750442, 1250738],# JOINT
        [9325, 22107, 34892, 48435, 61214, 312686, 375221, 625369],   # SEPARATE
        [18663, 44217, 56999, 70542, 83324, 425251, 510303, 850503],  # HEAD
        [18650, 44214, 69784, 96870, 122428, 625372, 750442, 1250738],# WIDOW
    ]
    SDI_MAX = 1539.58
