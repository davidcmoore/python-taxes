    ...
    def __init__(self, inputs):
        ...
        if not useLong(inputs):
            ...
            if self['A4'] <= SS_WAGE_LIMIT:
                ...
                self['A5'] = self['A4'] * .029 + 11450.40
            if self['A5'] <= 14643.30:
                self['A6'] = self['A5'] * .5751
            else:
                self['A6'] = self['A5'] * .50 + 1100
        else:
            ...
            if self['B8a'] < 110100:
                ...
                if self['B9'] <= 0:
                    ...
                    self['B10'] = min(self['B6'], self['B9']) * .104
            self['B11'] = self['B6'] * .029
            self['B12'] = self.rowsum(['B10', 'B11'])
            self['B13'] = self['B10'] * .596 + self['B11'] * .5
