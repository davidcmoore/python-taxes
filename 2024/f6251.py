...
class F6251(Form):
    ...
    EXEMPTIONS = [85700, 133300, 66650, 85700, 133300]
    EXEMPT_LIMITS = [609350, 1218700, 609350, 609350, 1218700]
    RATE_CHANGE = [232600, 232600, 116300, 232600, 232600]
    def __init__(f, inputs, f1040, sched_a, sched_d, sched_d_re):
        ...
        f['2a'] = sched_a.get('7') if sched_a else f1040.get('12')
