...
class F8801_2025(Form):
    """Form 8801, Credit for Prior Year Minimum Tax

    This form is for 2025, but since it depends on values
    from 2024, it is generated along with 2024's
    forms. Line 21 from this form must be manually entered into
    2025's inputs dictionary as 'prior_amt_credit'.
    """
    def __init__(f, inputs, f1040, f6251, f8801, sched_d):
        super(F8801_2025, f).__init__(inputs)
        ...
        assert(inputs['status'] != FilingStatus.SEPARATE or f['4'] <= 875950)
        ...
        f['17'] = f.get('15')
        f['18'] = f['16'] - f['17']
        f.comment['19'] = '2024 credit carryforward'
        f['19'] = f8801.get('26')
        f.comment['21'] = 'Accum. credit (enter in 2025 inputs as \'prior_amt_credit\')'
        f['21'] = max(0, f['18'] + f['19'] + f['20'])
        if f['21']:
            f.must_file = True

    def title(self):
        return 'Form 8801 (for 2025 filing)'
