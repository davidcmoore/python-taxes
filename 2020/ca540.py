...
class CA540(Form):
    EXEMPTION = 124
    DEPENDENT_EXEMPTION = 383
    BRACKET_RATES = [.01, .02, .04, .06, .08, .093, .103, .113, .123]
    BRACKET_LIMITS = [
        [8932, 21175, 33421, 46394, 58634, 299508, 359407, 599012],   # SINGLE
        [17864, 42350, 66842, 92788, 117268, 599016, 718814, 1198024],# JOINT
        [8932, 21175, 33421, 46394, 58634, 299508, 359407, 599012],   # SEPARATE
        [17864, 42353, 54597, 67569, 79812, 407329, 488796, 814658],  # HEAD
        [17864, 42350, 66842, 92788, 117268, 599016, 718814, 1198024],# WIDOW
    ]
    SDI_MAX = 1229.09
    ...
    def __init__(f, inputs, f1040):
        ...
        f.comment['65'] = 'Total tax'
        f['65'] = f.rowsum(['48', '61', '62', '63', '64'])
