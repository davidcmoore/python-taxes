...
class F6251(Form):
    ...
    EXEMPTIONS = [72900, 113400, 56700, 72900, 113400]
    EXEMPT_LIMITS = [518400, 1036800, 518400, 518400, 1036800]
    RATE_CHANGE = [197900, 197900, 98950, 197900, 197900]
    def __init__(f, inputs, f1040, sched_a, sched_d, sched_d_re):
        ...
        f['1'] = f1040.get('15')
        if f['1'] == 0:
            f['1'] = f1040['11'] - f1040['12'] - f1040['13']
