...
class CA540sca(Form):
    STD_DED = [4537, 9074, 4537, 9074, 9074]

    def __init__(f, inputs, f1040, f1040sa):
        super(CA540sca, f).__init__(inputs)
        f['1B_B7'] = f1040.get('s1_7')
        f['1B_B9'] = f.rowsum(['1A_B1', '1A_B2b', '1A_B3b', '1A_B4b', '1A_B4d',
                               '1A_B5b', '1A_B6', '1B_B1', '1B_B3', '1B_B4',
                               '1B_B5', '1B_B6', '1B_B7', '1B_B8a', '1B_B8b',
                               '1B_B8d', '1B_B8e', '1B_B8f', '1B_B8g'])
        f['1B_C9'] = f.rowsum(['1A_C1', '1A_C2b', '1A_C3b', '1A_C4b', '1A_C4d',
                               '1A_C6', '1B_C2a', '1B_C3', '1B_C4',
                               '1B_C5', '1B_C6', '1B_C8c', '1B_C8f'])
        f['1C_B22'] = f.rowsum(['1C_B10', '1C_B11', '1C_B12', '1C_B21'])
    ...
    def itemized_deductions_worksheet(f, inputs, f1040, f1040sa):
        ...
        w = {}
        w['1'] = f['2_28']
        if f1040['8b'] <= LIMITS[inputs['status']]:
            return w['1']
