...
class CA540sp(Form):
    EXEMPTION_LIMITS = [317062, 422750, 211371, 317062, 422750]
    EXEMPTIONS = [84550, 112734, 56364, 84550, 112734]
    ...
    def __init__(f, inputs, ca540, ca540sca, f1040, f1040sa):
        ...
        f['21'] = f['19'] - f['20']
        assert(inputs['status'] != FilingStatus.SEPARATE or f['21'] <= 436827)
