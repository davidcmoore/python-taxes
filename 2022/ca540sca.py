...
class CA540sca(Form):
    STD_DED = [5202, 10404, 5202, 10404, 10404]
    ...
    def __init__(f, inputs, f1040, f1040sa):
        ...
        f['1B_B9a'] = f.rowsum(['1B_B8b', '1B_B8c', '1B_B8f', '1B_B8n', '1B_B8o',
                                '1B_B8p', '1B_B8z'])
        f['1B_C9a'] = f.rowsum(['1B_C8a', '1B_C8c', '1B_C8d', '1B_C8e', '1B_C8k',
                                '1B_C8p', '1B_C8z'])
        f['1B_B10'] = f.rowsum(['1A_B1z', '1A_B2b', '1A_B3b', '1A_B4b', '1A_B5b',
                                '1A_B6b', '1A_B7', '1B_B1', '1B_B3', '1B_B4',
                                '1B_B5', '1B_B6', '1B_B7', '1B_B9a', '1B_B9b1',
                                '1B_B9b2', '1B_B9b3'])
        f['1B_C10'] = f.rowsum(['1A_C7', '1B_C2a', '1B_C9a', '1A_C1[a-i]', '1A_C[2345]b', '1B_C[3-6]'])
