...
class F6251(Form):
    ...
    EXEMPTIONS = [70300, 109400, 54700, 70300, 109400]
    EXEMPT_LIMITS = [500000, 1000000, 500000, 500000, 1000000]
    RATE_CHANGE = [191100, 191100, 95550, 191100, 191100]
    def __init__(f, inputs, f1040, sched_a, sched_d, sched_d_re):
        ...
        f['1'] = f1040.get('10')
        if f['1'] == 0:
            f['1'] = f1040['7'] - f1040['8'] - f1040['9']
        f['2a'] = sched_a.get('7') if sched_a else f1040.get('8')
        if 's10' in f1040:
        ...
        if f['6'] <= 0:
            ...
            f['6'] = 0
            f['10'] = f1040['11a'] + f1040['s46'] - f1040['s48']
            return
