...
class F8801_2019(Form):
    """Form 8801, Credit for Prior Year Minimum Tax

    This form is for 2019, but since it depends on values
    from 2018, it is generated along with 2018's
    forms. Line 21 from this form must be manually entered into
    2019's input dictionary.
    """
    def __init__(f, inputs, f1040, f6251, f8801, sched_d):
        super(F8801_2019, f).__init__(inputs)
        ...
        if f['4'] == 0:
            ...
            if f['10'] == 0:
                ...
                # TODO: form 2555
                if (f1040['s13'] and not sched_d.mustFile()) or f1040['3a'] or \
        ...
        f['17'] = f.get('15')
        f['18'] = f['16'] - f['17']
        f.comment['19'] = '2018 credit carryforward'
        f['19'] = f8801.get('26')
        f.comment['21'] = 'Accum. credit (enter in 2019 inputs as \'prior_amt_credit\')'
