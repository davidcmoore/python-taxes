...
class F6251(Form):
    ...
    EXEMPTIONS = [52800, 82100, 41050, 52800, 82100]
    EXEMPT_LIMITS = [117300, 156500, 78250, 117300, 156500]
    RATE_CHANGE = [182500, 182500, 91250, 182500, 182500]
    # Second column of BRACKET_LIMITS on f1040
    CAP_GAIN_LIMITS = [36900, 73800, 36900, 49400, 73800]
