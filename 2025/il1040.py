...
class IL1040(Form):
    """
    Form IL-1040 implementation for 2025
    ...
    This class represents the Illinois Individual Income Tax Return (Form IL-1040) for the tax year 2025.
    ...
    """
    PERSONAL_EXEMPTION = 2850  # 2025 IL value
    DEPENDENT_EXEMPTION = 2850
    AGE_BLIND = 1000
    TAX_RATE = 0.0495  # 2025 IL flat rate
    ...
    def __init__(f, inputs, f1040):
        ...
        f['10'] = 0.
        if inputs['status'] == FilingStatus.JOINT and f1040['11a'] < 500000 or \
           f1040['11a'] < 250000:
